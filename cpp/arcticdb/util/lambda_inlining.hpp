...
// Forces all direct calls within the attributed function to be inlined.
// Use on small wrapper functions around hot loops to ensure callees (e.g. hash map lookups)
// are inlined without bloating the outer function's register pressure.
